...
## 使用方法
1. **下载工具**：从提供的资源文件中下载 IIS-ShortName-Scanner。
2. **配置环境**：确保系统中已安装 Java 运行环境（JRE）。
3. **运行工具**：双击 `run.bat` 文件启动工具。
4. **参数设置**：根据需要设置扫描参数，例如目标 URL、扫描深度等。
5. **查看结果**：等待扫描完成后，查看生成的报告文件，了解检测结果。
...
[IIS-ShortName-Scanner使用指南分享](https://pan.quark.cn/s/dc337112d26c)