...
| CUDA版本 | Pytorch版本 |
|----------|-------------|
| CUDA 11.6| Pytorch 1.12.0及以上 |
| CUDA 11.3| Pytorch 1.10.0 - 1.11.0 |
| CUDA 10.2| Pytorch 1.4.0 - 1.9.0 |
| CUDA 9.0 | Pytorch 0.4.1 - 1.3.1 |
...
[CUDA安装包及Pytorch版本对应表Windows10](https://pan.quark.cn/s/2e530dfa75e6)