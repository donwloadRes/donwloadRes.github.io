...
本仓库提供了IOI国家集训队论文集（1999-2019）的资源文件下载。这些论文涵盖了从1999年到2019年期间，国家集训队成员在信息学竞赛中的研究成果和解题思路。论文内容丰富，涉及组合数学、数据结构、图论、树、数论、搜索、动态规划等多个领域，是信息学竞赛爱好者和研究者的重要参考资料。
...
- 李益明 - 《计算几何的相关问题》
- 李源 - 《树的枚举》
- 骆骥 - 《由汽车问题浅谈深度搜索的一个方面——搜索对象与策略的重要性》
- 毛子青 - 《动态规划算法的优化技巧》
- 俞玮 - 《基本动态规划问题的扩展》
- 张一飞 - 《求N!的高精度算法》

### 2002
- 戴德承 - 《退一步海阔天空——目标转化思想的若干应用》
- 方奇 - 《浅谈必要条件的应用》
- 符文杰 - 《排序网络》
- 何江舟 - 《用高斯消元法解线性方程组》
- 何林 - 《猜想及其应用》
...
- 伍昱 - 《由对称性解2-SAT问题》
- 项荣璟 - 《充分利用问题性质——例析动态规划的个性化优化》
- 许智磊 - 《浅谈补集转化思想在统计问题中的应用》
- 张宁 - 《猜数问题的研究》
- 张云亮 - 《论对算法的选择》
- 周源 - 《浅析最小表示法思想在字符串循环同构问题中的应用》
...
[IOI国家集训队论文集1999-2019](https://pan.quark.cn/s/277911eeede3)