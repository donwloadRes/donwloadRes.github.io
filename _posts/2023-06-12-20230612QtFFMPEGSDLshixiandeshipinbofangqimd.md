...
- **Windows**：解压下载的压缩包，进入`bin`目录，双击运行`VideoPlayer.exe`。
- **Linux/macOS**：解压下载的压缩包，进入`bin`目录，在终端中运行以下命令：
...
[QtFFMPEGSDL实现的视频播放器](https://pan.quark.cn/s/f0b9270b62a3)